...
export class HypercubeGeometry extends BaseGeometry {
    getShaderCode() {
        return `
...
export class HypersphereGeometry extends BaseGeometry {
    getShaderCode() {
        return `
...
export class HypertetrahedronGeometry extends BaseGeometry {
     getShaderCode() {
        return `
...
export default class GeometryManager {
    options: { defaultGeometry: string };
    geometries: Record<string, BaseGeometry>;
    ...
    registerGeometry(name: string, instance: BaseGeometry) { 
    ...
    getGeometry(name?: string): BaseGeometry { 
